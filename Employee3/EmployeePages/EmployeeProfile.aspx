<%@ Page Title="" Language="C#" MasterPageFile="~/EmployeePages/EmployeeView.Master" AutoEventWireup="true" CodeBehind="EmployeeProfile.aspx.cs" Inherits="Employee3.EmployeePages.EmployeeProfile" %>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                            ...
                                            <asp:Label runat="server" ID="lblMale" CssClass="btn btn-default active">
                                                <asp:RadioButton runat="server" GroupName="MaritalStatus" type="radio" name="options" id="rbnMale" autocomplete="off" />
                                                 पुरुष
                                            </asp:Label>
                                            <asp:Label runat="server" ID="lblFemale" CssClass="btn btn-default active">
                                                
                                                <asp:RadioButton runat="server" GroupName="MaritalStatus" type="radio" name="options" id="rbnFemale" autocomplete="off"  />
                                                महिला
              
                                            </asp:Label>
                                                <asp:Label runat="server" ID="lblOtherSex" CssClass="btn btn-default active">
                                                
                                                <asp:RadioButton runat="server" GroupName="MaritalStatus" type="radio" name="options" id="rbnOtherSex" autocomplete="off"  />
                                                अन्य              
                                            </asp:Label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="btn-group" data-toggle="buttons">
                                            <asp:Label runat="server" ID="lblUnMarried" CssClass="btn btn-default active">
                                                <asp:RadioButton runat="server" GroupName="MaritalStatus" type="radio" name="options" id="rbnUnMarred" autocomplete="off" />
                                                 अविवाहित
                                            </asp:Label>
                                            <asp:Label runat="server" ID="lblMarried" CssClass="btn btn-default active">
                                                
                                                <asp:RadioButton runat="server" GroupName="MaritalStatus" type="radio" name="options" id="rbnMarried" autocomplete="off"  />
                                                विवाहित
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="btn-group" data-toggle="buttons">
                                            <asp:Label runat="server" ID="lblIsWorking" CssClass="btn btn-default active">
                                                ...
                                                <asp:RadioButton runat="server" GroupName="Activeness" type="radio" name="options" id="rbnWorking" autocomplete="off" checked />

                                                कार्यरत
                                            </asp:Label>
                                            <asp:Label runat="server" ID="Label1" CssClass="btn btn-default active">
                                                
                                                <asp:RadioButton runat="server" GroupName="Activeness" type="radio" name="options" id="rbnRetired" autocomplete="off"  />

                                                अवकाश प्राप्त
                                            </asp:Label>
                                            <asp:Label runat="server" ID="Label2" CssClass="btn btn-default active">
                                                
                                                <asp:RadioButton runat="server" GroupName="Activeness" type="radio" name="options" id="rbnOther" autocomplete="off"  />
